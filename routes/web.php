...
Route::middleware(['auth:user'])->group(function(){
    ...
    Route::get('/presensi/exportlaporanpdf', [PresensiController::class, 'export']);
    Route::get('/presensi/exportrekappdf', [PresensiController::class, 'exportrekap']);
    ...
    //izin
    // Route::get('/izin/index', [IzinabsenController::class, 'izin']);
    // Route::post('/izin/approveizin', [IzinabsenController::class, 'approveizin']);
    // Route::get('/izin/{kode_izin}/batalkanizin', [IzinabsenController::class, 'batalkanizin']);

    //sakit
    // Route::get('/sakit/index', [IzinsakitController::class, 'sakit']);
    // Route::post('/sakit/approveizin', [IzinsakitController::class, 'approvesakit']);
    // Route::get('/sakit/{kode_izin}/batalkanizin', [IzinsakitController::class, 'batalkansakit']);
