...
<html lang="en">
  <head>
    ...
    <!-- CSS files -->
    <link href="{{ asset('tabler/dist/css/tabler.min.css?1691487027') }}" rel="stylesheet"/>
    <link href="{{ asset('tabler/dist/css/tabler-flags.min.css?1691487027') }}" rel="stylesheet"/>
    <link href="{{ asset('tabler/dist/css/tabler-payments.min.css?1691487027') }}" rel="stylesheet"/>
    <link href="{{ asset('tabler/dist/css/tabler-vendors.min.css?1691487027') }}" rel="stylesheet"/>
    <link href="{{ asset('tabler/dist/css/demo.min.css?1691487027') }}" rel="stylesheet"/>
  ...
  <body >
    <script src="{{ asset('tabler/dist/js/demo-theme.min.js?1691487027') }}"></script>
    <div class="page">
      <!-- Sidebar -->
