...
<style>
 ...
 <div class="appHeader bg-primary text-light">
    ...
    <div class="pageTittle">Edit Izin Absen</div>
    <div class="right"></div>
 </div>
 <!-- App Header -->
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="/izinabsen/{{ $dataizin->kode_izin }}/update" id="frmIzin">
                        ...
                        <div class="form-group">
                            <input type="text" id="jml_hari" readonly name="jml_hari" class="form-control" autocomplete="off"
                            placeholder="Jumlah Hari">
                        </div>
                        <div class="form-group">
                            <input type="text" name="keterangan" id="keterangan" value="{{ $dataizin->keterangan }}" cols="30" rows="5" class="form-control" placeholder="keterangan">
                        </div>
                        <div class="form-group">
