...
@section('title', 'Jam Kerja Departemen')
@section('content')
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="d-flex justify-content-between">
                                                        ...
                                                        <a href="/konfigurasi/jamkerjadept/{{ $d->kode_jk_dept }}/show" class=" btn btn-success btn-sm">
                                                        ...
                                                        <a href="/konfigurasi/jamkerjadept/{{ $d->kode_jk_dept }}/delete" class=" btn btn-danger btn-sm delete-confirm">
