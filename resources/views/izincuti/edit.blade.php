...
<style>
 ...
 <div class="appHeader bg-primary text-light">
    ...
    <div class="pageTittle">Edit Izin Cuti</div>
    <div class="right"></div>
 </div>
 <!-- App Header -->
@endsection
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="/izincuti/{{ $dataizin->kode_izin }}/update" id="frmIzin">
                        ...
                        <div class="form-group">
                            <input type="text" value="{{ $dataizin->keterangan }}" name="keterangan" id="keterangan" cols="30" rows="5" class="form-control" placeholder="keterangan">
                        <div class="form-group">
