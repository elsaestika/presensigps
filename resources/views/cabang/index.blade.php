      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="/cabang/store" method="POST" id="frmCabang">
                ...
                <div class="row">
                    <div class="col-12">
                        <label for="form" class="form-label">Kode Cabang</label>
                ...
                <div class="row">
                    <div class="col-12">
                        <label for="form" class="form-label">Nama Cabang</label>
                        <div class="input-icon mb-3">
                            <span class="input-icon-addon">
                              <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                ...
                <div class="row">
                    <div class="col-12">
                        <label for="form" class="form-label">Lokasi cabang</label>
                        <div class="input-icon mb-3">
                            <span class="input-icon-addon">
                              <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                            ...
                            <input type="text" value="" id="lokasi_cabang" class="form-control" name="lokasi_cabang" placeholder="00000,0000">
                          </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <label for="form" class="form-label">Radius cabang</label>
                        <div class="input-icon mb-3">
                            <span class="input-icon-addon">
                              <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                            ...
                            <input type="text" value="" id="radius_cabang" class="form-control" name="radius_cabang" placeholder="0 meter">
                          </div>
                    </div>
                </div>
                <div class="row mt-2">
